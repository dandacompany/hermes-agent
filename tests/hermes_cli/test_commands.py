...
class TestSlackAppManifest:
    ...
    def test_full_manifest_enables_dm_messages(self):
        m = _build_full_manifest("Hermes", "Test Hermes")
    ...
    def test_full_manifest_includes_directory_scopes(self):
        m = _build_full_manifest("Hermes", "Test Hermes")
        scopes = set(m["oauth_config"]["scopes"]["bot"])
        assert "groups:read" in scopes
        assert "mpim:read" in scopes
